import img from "../../assets/AboutUs/why-us.png"

const WhoWeAre = () => {
  return (
    <div className="relative w-full h-screen bg-cover bg-center" style={{ backgroundImage: `url(${img})` }}>
      <div className="absolute inset-0 bg-black bg-opacity-50 flex justify-center items-center">
        <div className="bg-secondary bg-opacity-70 p-8 py-12 rounded-xl text-center max-w-3xl llg:h-[300px] h-auto mx-auto">
          <h1 className="text-3xl font-semibold mb-8">Who Are We?</h1>
