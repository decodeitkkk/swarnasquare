...
//         <div
//           className="w-[630px] h-auto bg-[#1f2029] rounded-lg shadow-lg flex items-center justify-center mb-[80px] p-[75px] border-2"
//           style={{
//             borderColor: "#ffeba7",
//             boxShadow: "0 0 15px rgba(255, 215, 0, 0.3)",
//           }}
//         >
//           <div className="space-y-4 px-4 m-1">
//             <h2 className="text-[25px] font-semibold font-sans text-white text-center pb-10">
//               Sign up
//             </h2>
...
//                   className="w-full bg-black text-gray-400 px-8 py-2 text-sm rounded-lg border-transparent focus:border-transparent focus:ring-0"
//                 />
//                 <PersonIcon
...
//             </div>
//             {/* Phone Number Input/}
//             <div className="relative flex items-center bg-black rounded-lg border border-transparent">
//               {/* Phone Icon/}
//               <PhoneIcon
...
//               {/* Country Code/}
//               <span className="text-gray-400 px-3 py-2 ml-8">+91</span>

//               {/* Phone Number Input/}
//               <input
//                 type="tel"
//                 placeholder="Phone Number"
//                 className="flex-1 bg-black text-gray-400 px-4 py-2 text-sm rounded-r-lg border-transparent focus:border-transparent focus:ring-0"
//                 style={{
...
//                 type="checkbox"
//                 id="terms"
//                 className="mr-2 border-transparent focus:border-transparent focus:ring-0"
//               />
//               <label htmlFor="terms">
//                 We accept your{" "}
//                 <a href="#" className="hover:text-[#ffeba7] underline">
//                   terms & conditions
//                 </a>
//               </label>
//             </div>
//             <div style={{ marginTop: "2.5rem" }} className="mt-10">
