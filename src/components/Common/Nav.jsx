  ...
  return (
    <nav className="backdrop-blur-sm bg-primary fixed w-full z-20 text-white p-5 md:text-lg">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div className="hidden md:flex space-x-4">
          ...
          <div className="relative group ">
            ...
            <div className="absolute hidden group-hover:block mt-2 w-48 bg-primary rounded-md shadow-lg">
              <a
                href="/about/why-us"
                className="block px-4 py-2 text-sm text-white hover:bg-yellow-100"
              >
                Why us?
              </a>
              <a
        ...
        <a href="/signupsignin" className=" text-white hover:text-yellow-300 hover:underline hidden md:block">
          Sign In/ Sign Up
        </a>
        <div className="md:hidden">
          <a onClick={() => setIsOpen(!isOpen)}>
            {isOpen ? (
              <X className="text-white hover:text-yellow-400 hover:underline" />
            ) : (
              <Menu className="text-white hover:text-yellow-400 hover:underline" />
            )}
          </a>
        </div>
      </div>
      {isOpen && (
        <div className="md:hidden backdrop-blur-sm bg-primary">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <a
              href="/signupsignin"
              className="w-full text-left text-white px-3 py-2 rounded-md text-base font-medium hover:text-yellow-400 underline cursor-pointer"
            >
              Sign In/ Sign Up
            </a>
          </div>
